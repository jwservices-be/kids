...
if (diffPanelLeft) {
  ...
  const SCENES = [
    ...
    },
    {
      name: 'bos',
      left: [
        ['🌳', 15, 20, 2.6], ['🌲', 45, 15, 2.4], ['🦉', 75, 20, 2], ['🍄', 20, 50, 1.8],
        ['🦊', 50, 50, 2.4], ['🐿️', 80, 50, 2], ['🌿', 15, 80, 1.8], ['🍂', 50, 80, 1.6],
        ['🦌', 80, 80, 2.4], ['🌳', 10, 45, 2.6], ['🐝', 65, 30, 1.4], ['☀️', 90, 10, 1.8],
      ],
      right: [
        ['🌳', 15, 20, 2.6], ['🌲', 45, 15, 2.4], ['🦇', 75, 20, 2], ['🍄', 20, 50, 1.8],
        ['🦊', 50, 50, 2.4, true], ['🐿️', 80, 50, 2], ['🌿', 15, 80, 1.8], ['🍂', 50, 80, 1.6],
        ['🦌', 70, 65, 2.4], ['🌳', 10, 45, 3.6], ['☀️', 90, 10, 1.8],
      ],
      diffs: [
        { lx: 75, ly: 20, rx: 75, ry: 20, r: 9 },
        { lx: 50, ly: 50, rx: 50, ry: 50, r: 9 },
        { lx: 80, ly: 80, rx: 70, ry: 65, r: 9 },
        { lx: 10, ly: 45, rx: 10, ry: 45, r: 10 },
        { lx: 65, ly: 30, rx: 65, ry: 30, r: 9 },
      ],
    },
    {
      name: 'stad',
      left: [
        ['🚗', 15, 60, 2.4], ['🚕', 45, 65, 2.4], ['🚦', 75, 30, 2.6], ['🏢', 20, 20, 3],
        ['🏬', 50, 15, 2.8], ['🌳', 80, 60, 2.2], ['🚲', 30, 80, 2], ['🐦', 10, 15, 1.4],
        ['🚌', 65, 80, 2.6], ['🏠', 90, 40, 2.4], ['☁️', 40, 10, 1.8], ['🚏', 55, 45, 1.8],
      ],
      right: [
        ['🚗', 15, 60, 2.4], ['🚙', 45, 65, 2.4], ['🚦', 75, 30, 2.6], ['🏢', 20, 20, 4],
        ['🏬', 50, 15, 2.8], ['🌳', 85, 45, 2.2], ['🚲', 30, 80, 2, true], ['🚌', 65, 80, 2.6],
        ['🏠', 90, 40, 2.4], ['☁️', 40, 10, 1.8], ['🚏', 55, 45, 1.8],
      ],
      diffs: [
        { lx: 45, ly: 65, rx: 45, ry: 65, r: 9 },
        { lx: 20, ly: 20, rx: 20, ry: 20, r: 10 },
        { lx: 80, ly: 60, rx: 85, ry: 45, r: 9 },
        { lx: 30, ly: 80, rx: 30, ry: 80, r: 9 },
        { lx: 10, ly: 15, rx: 10, ry: 15, r: 9 },
      ],
    },
    {
      name: 'sport',
      left: [
        ['⚽', 50, 50, 3], ['🥅', 50, 10, 2.6], ['🥅', 50, 90, 2.6], ['🏃', 20, 30, 2.2],
        ['🏃', 80, 30, 2.2, true], ['🧤', 20, 70, 2], ['🎽', 80, 70, 2], ['🏆', 10, 15, 1.8],
        ['🎺', 90, 15, 1.8], ['🌤️', 15, 85, 1.8], ['🚩', 85, 85, 1.6], ['👟', 45, 25, 1.4],
      ],
      right: [
        ['⚽', 50, 50, 3], ['🥅', 50, 10, 3.6], ['🥅', 50, 90, 2.6], ['🏃', 20, 30, 2.2, true],
        ['🏃', 80, 30, 2.2, true], ['🧤', 20, 70, 2], ['🎽', 65, 55, 2], ['🥇', 10, 15, 1.8],
        ['🎺', 90, 15, 1.8], ['🌤️', 15, 85, 1.8], ['🚩', 85, 85, 1.6],
      ],
      diffs: [
        { lx: 50, ly: 10, rx: 50, ry: 10, r: 10 },
        { lx: 20, ly: 30, rx: 20, ry: 30, r: 9 },
        { lx: 80, ly: 70, rx: 65, ry: 55, r: 9 },
        { lx: 10, ly: 15, rx: 10, ry: 15, r: 9 },
        { lx: 45, ly: 25, rx: 45, ry: 25, r: 9 },
      ],
    },
    {
      name: 'trein',
      left: [
        ['🚂', 30, 50, 3], ['🚃', 60, 50, 2.6], ['🚉', 50, 15, 2.8], ['🧳', 15, 75, 2],
        ['🎫', 80, 75, 1.8], ['🕰️', 50, 80, 1.8], ['🚦', 10, 30, 1.8], ['🌳', 90, 30, 2.2],
        ['☁️', 20, 10, 1.8], ['☁️', 70, 10, 1.8], ['🚶', 35, 85, 1.8], ['🐦', 85, 15, 1.4],
      ],
      right: [
        ['🚂', 30, 50, 3], ['🚋', 60, 50, 2.6], ['🚉', 50, 15, 3.8], ['🧳', 25, 60, 2],
        ['🎫', 80, 75, 1.8], ['🕰️', 50, 80, 1.8], ['🚦', 10, 30, 1.8], ['🌳', 90, 30, 2.2],
        ['☁️', 20, 10, 1.8], ['☁️', 70, 10, 1.8], ['🚶', 35, 85, 1.8, true],
      ],
      diffs: [
        { lx: 60, ly: 50, rx: 60, ry: 50, r: 9 },
        { lx: 50, ly: 15, rx: 50, ry: 15, r: 10 },
        { lx: 15, ly: 75, rx: 25, ry: 60, r: 9 },
        { lx: 35, ly: 85, rx: 35, ry: 85, r: 9 },
        { lx: 85, ly: 15, rx: 85, ry: 15, r: 9 },
      ],
    },
    {
      name: 'jungle',
      left: [
        ['🐒', 20, 30, 2.4], ['🦜', 60, 20, 2], ['🐍', 40, 60, 2.2], ['🌴', 15, 70, 2.8],
        ['🌴', 85, 70, 2.8], ['🍌', 50, 45, 1.6], ['🐆', 75, 55, 2.4], ['🦋', 30, 15, 1.4],
        ['🌺', 65, 80, 1.8], ['🐸', 20, 85, 1.8], ['☀️', 90, 10, 1.8], ['🍃', 10, 15, 1.6],
      ],
      right: [
        ['🐒', 20, 30, 2.4, true], ['🦜', 60, 20, 2], ['🐍', 40, 60, 2.2], ['🌴', 15, 70, 4],
        ['🌴', 85, 70, 2.8], ['🍌', 50, 45, 1.6], ['🐅', 75, 55, 2.4], ['🦋', 30, 15, 1.4],
        ['🌺', 65, 80, 1.8], ['🐸', 40, 80, 1.8], ['☀️', 90, 10, 1.8],
      ],
      diffs: [
        { lx: 20, ly: 30, rx: 20, ry: 30, r: 9 },
        { lx: 15, ly: 70, rx: 15, ry: 70, r: 10 },
        { lx: 75, ly: 55, rx: 75, ry: 55, r: 9 },
        { lx: 20, ly: 85, rx: 40, ry: 80, r: 9 },
        { lx: 10, ly: 15, rx: 10, ry: 15, r: 9 },
      ],
    },
    {
      name: 'woestijn',
      left: [
        ['🐫', 30, 60, 2.8], ['🌵', 15, 40, 2.4], ['🌵', 80, 40, 2.4], ['☀️', 50, 10, 2.4],
        ['🦂', 60, 80, 1.8], ['🏜️', 50, 50, 3], ['🦎', 20, 80, 1.8], ['⛺', 75, 70, 2.2],
        ['🪨', 10, 65, 1.8], ['🌙', 85, 15, 1.6], ['⭐', 65, 15, 1.4], ['🐍', 40, 85, 1.8],
      ],
      right: [
        ['🐫', 30, 60, 2.8, true], ['🌵', 15, 40, 3.6], ['🌵', 80, 40, 2.4], ['☀️', 50, 10, 2.4],
        ['🕷️', 60, 80, 1.8], ['🏜️', 50, 50, 3], ['🦎', 20, 80, 1.8], ['⛺', 65, 55, 2.2],
        ['🪨', 10, 65, 1.8], ['⭐', 65, 15, 1.4], ['🐍', 40, 85, 1.8],
      ],
      diffs: [
        { lx: 30, ly: 60, rx: 30, ry: 60, r: 9 },
        { lx: 15, ly: 40, rx: 15, ry: 40, r: 10 },
        { lx: 60, ly: 80, rx: 60, ry: 80, r: 9 },
        { lx: 75, ly: 70, rx: 65, ry: 55, r: 9 },
        { lx: 85, ly: 15, rx: 85, ry: 15, r: 9 },
      ],
    },
    {
      name: 'kasteel',
      left: [
        ['🏰', 50, 40, 3.4], ['🐉', 20, 20, 2.6], ['🤴', 75, 70, 2.2], ['👸', 25, 75, 2.2],
        ['⚔️', 50, 80, 2], ['🛡️', 60, 15, 1.8], ['🌳', 10, 60, 2.4], ['🌳', 90, 60, 2.4],
        ['☁️', 35, 10, 1.8], ['🦅', 80, 15, 1.6], ['🕯️', 15, 45, 1.4], ['🚩', 50, 10, 1.8],
      ],
      right: [
        ['🏰', 50, 40, 4.4], ['🦕', 20, 20, 2.6], ['🤴', 75, 70, 2.2, true], ['👸', 25, 75, 2.2],
        ['⚔️', 50, 80, 2], ['🛡️', 60, 15, 1.8], ['🌳', 10, 60, 2.4], ['🌳', 90, 60, 2.4],
        ['☁️', 35, 10, 1.8], ['🕯️', 15, 30, 1.4], ['🚩', 50, 10, 1.8],
      ],
      diffs: [
        { lx: 50, ly: 40, rx: 50, ry: 40, r: 11 },
        { lx: 20, ly: 20, rx: 20, ry: 20, r: 9 },
        { lx: 75, ly: 70, rx: 75, ry: 70, r: 9 },
        { lx: 15, ly: 45, rx: 15, ry: 30, r: 9 },
        { lx: 80, ly: 15, rx: 80, ry: 15, r: 9 },
      ],
    },
    {
      name: 'ijssalon',
      left: [
        ['🍦', 20, 50, 2.6], ['🍨', 45, 45, 2.4], ['🍧', 70, 50, 2.4], ['🧁', 20, 80, 2],
        ['🍰', 50, 80, 2], ['🎂', 80, 80, 2.2], ['☀️', 85, 15, 2], ['🌴', 10, 15, 2.2],
        ['🪑', 35, 25, 1.8], ['🍓', 60, 25, 1.6], ['🍒', 15, 65, 1.4], ['🎈', 90, 45, 1.8],
      ],
      right: [
        ['🍦', 20, 50, 2.6, true], ['🍨', 45, 45, 2.4], ['🍹', 70, 50, 2.4], ['🧁', 20, 80, 2],
        ['🍰', 50, 80, 3.2], ['🎂', 80, 80, 2.2], ['☀️', 85, 15, 2], ['🌴', 10, 15, 2.2],
        ['🪑', 35, 25, 1.8], ['🍓', 60, 25, 1.6], ['🍒', 30, 60, 1.4],
      ],
      diffs: [
        { lx: 20, ly: 50, rx: 20, ry: 50, r: 9 },
        { lx: 70, ly: 50, rx: 70, ry: 50, r: 9 },
        { lx: 50, ly: 80, rx: 50, ry: 80, r: 10 },
        { lx: 15, ly: 65, rx: 30, ry: 60, r: 9 },
        { lx: 90, ly: 45, rx: 90, ry: 45, r: 9 },
      ],
    },
    {
      name: 'speeltuin',
      left: [
        ['🛝', 25, 50, 3], ['🎠', 65, 45, 2.8], ['⚽', 40, 80, 1.8], ['🧒', 15, 25, 2],
        ['👧', 80, 25, 2], ['🌳', 10, 60, 2.4], ['🌳', 90, 60, 2.4], ['☀️', 50, 10, 2.2],
        ['🐦', 30, 15, 1.4], ['🦋', 70, 15, 1.4], ['🪁', 85, 80, 2], ['🐕', 50, 85, 1.8],
      ],
      right: [
        ['🛝', 25, 50, 4], ['🎡', 65, 45, 2.8], ['⚽', 40, 80, 1.8], ['🧒', 15, 25, 2],
        ['👧', 80, 25, 2, true], ['🌳', 10, 60, 2.4], ['🌳', 90, 60, 2.4], ['☀️', 50, 10, 2.2],
        ['🐦', 30, 15, 1.4], ['🦋', 70, 15, 1.4], ['🪁', 70, 65, 2],
      ],
      diffs: [
        { lx: 25, ly: 50, rx: 25, ry: 50, r: 10 },
        { lx: 65, ly: 45, rx: 65, ry: 45, r: 9 },
        { lx: 80, ly: 25, rx: 80, ry: 25, r: 9 },
        { lx: 85, ly: 80, rx: 70, ry: 65, r: 9 },
        { lx: 50, ly: 85, rx: 50, ry: 85, r: 9 },
      ],
    },
    {
      name: 'vissersboot',
      left: [
        ['⛵', 50, 45, 3], ['🎣', 20, 30, 2.2], ['🐟', 70, 70, 2], ['🐟', 80, 60, 2],
        ['🌊', 50, 80, 2.2], ['☀️', 85, 15, 2], ['☁️', 20, 10, 1.8], ['⚓', 15, 70, 2],
        ['🦆', 35, 75, 1.8], ['🏝️', 90, 80, 2.4], ['🐦', 60, 15, 1.4], ['🪣', 30, 55, 1.6],
      ],
      right: [
        ['⛵', 50, 45, 3, true], ['🎣', 20, 30, 2.2], ['🐟', 70, 70, 2], ['🐟', 80, 60, 2],
        ['🌊', 50, 80, 2.2], ['☀️', 85, 15, 2], ['☁️', 20, 10, 1.8], ['⚓', 25, 55, 2],
        ['🦢', 35, 75, 1.8], ['🏝️', 90, 80, 3.4], ['🪣', 30, 55, 1.6],
      ],
      diffs: [
        { lx: 50, ly: 45, rx: 50, ry: 45, r: 10 },
        { lx: 15, ly: 70, rx: 25, ry: 55, r: 9 },
        { lx: 35, ly: 75, rx: 35, ry: 75, r: 9 },
        { lx: 90, ly: 80, rx: 90, ry: 80, r: 10 },
        { lx: 60, ly: 15, rx: 60, ry: 15, r: 9 },
      ],
    },
  ];
